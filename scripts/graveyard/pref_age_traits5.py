...
class Keywords(object):
    ...
    def roof(self, limits, xmax, ymax, num_rows, file):
    ...
    def dot_for_graphviz(self, selected_layer, focus):                 
        ...
        phylo_colors = self.colors_for_graphviz("svg")
...
""" % selected_layer
        ...
        starting_y = self.roof(limits, xmax, ymax, num_rows, file)
        self.grid(100, 1000, 100, xmax, ymax, starting_y, num_rows, file) 
...
class Testing(object):
    ...
    def lets_cite(self):              
        self.some_patents = Uniform(number_of_patents=1000, citations_per_patent=5, avg=False, 
                 min_citations_per_patent=0, initial_weight = 1)
    ...
    def lets_keyword(self):
        self.key_up = Keywords("parentage.csv", keywords_per_patent=3, avg=False, 
